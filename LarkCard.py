...
class cp_header_icon(component):
    _meta_add = dict(tag = field(REQUIRED,str,NODEFAULT),
                     token = field(UNREQUIRED,str,EMPTY),
                     color = field(UNREQUIRED,str,EMPTY),
                     img_key = field(UNREQUIRED,str,EMPTY),
...
class header(component):
    _meta_add = dict(title = field(REQUIRED,text,NODEFAULT),
                     ...
                     icon = field(UNREQUIRED,icon,EMPTY),
...
class ud_style(component):
    _meta_add = dict(style = field(REQUIRED,str,NODEFAULT))

class ud_icon(component):
    _meta_add = dict(token = field(REQUIRED,str,NODEFAULT),
                     style = field(UNREQUIRED,ud_style,EMPTY)
                    )
...
class person_list(presenter):
    _meta_add = dict(tag = field(FIXED,str,'person_list'),
                     ...
                     icon = field(UNREQUIRED,icon,EMPTY),
                     ud_icon = field(UNREQUIRED,ud_icon,EMPTY))
